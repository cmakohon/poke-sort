...
const FIELD_NOTES = {
  _README: [
    ...
    "scanCorners are the scan area's four corners as fractions of the frame",
    "(0-1), labelled as the card sees them, not the frame. They supersede",
    "scanRegion; a file carrying both applies the corners.",
